...
// add code here to set diameter correctly or write a helper method to do it
        ...
        for (int i = 0; i < myGraph.getNumberOfVertices(); i++) {
            for (int j = 0; j < myGraph.getNumberOfVertices(); j++) {
                ...
                if (((WeightedAdjMatrixGraph<String>) myGraph).minimalPath(
                                                     vertices[i], vertices[j]) > diameter) {
                    diameter = ((WeightedAdjMatrixGraph<String>) myGraph).minimalPath(
...
// add code here to set path_length correctly
        pathLength = 
                ((WeightedAdjMatrixGraph<String>) myGraph).minimalPath(thePoint1, thePoint2);
