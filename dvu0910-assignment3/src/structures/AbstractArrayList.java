 ...
 * @version  Spring 2021
 * 
 * @param <T> the generic placeholder
 */
public abstract class AbstractArrayList<T> implements ListADT<T>, Iterable<T> {
    ...
    /** The index of the first open array index
     *  after the last element at the rear of this List.
     *  
     *  This also indicates the number of elements currently in the List.
     */
    ...
    public T removeFirst() throws EmptyCollectionException {
        ...
        /** shift the elements */
        myList = Arrays.copyOfRange(myList, 1, myList.length + 1);
        myRear--;
        myModCount++;
