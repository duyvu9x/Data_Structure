...
public class ArrayStack<T> implements StackADT<T> {
    ...
    public ArrayStack(final int theInitialCapacity) {
        ...
        // the cast produces a warning but is necessary - see page 55 of Lewis and Chase
    ...
    /*
     * Javadoc is automatically inherited from the parent for inherited methods.
     * (Inherited from a parent class or from a parent interface)
     ...
     * 
     * If the inherited javadoc is sufficient, then there is no need to add javadoc here.  
     */
     ...
     * 
     * An empty stack will return the String "Empty Stack";
     * otherwise, the returned String will include
     * the elements of the stack, one per line.
     * 
    ...
    public String toString() {
        ...
        if (isEmpty()) {
            ...
            for (int index = mySize - 1; index >= 0; index--) {
                sb.append(myElements[index]).append('\n');
            }
        }
        return sb.toString();
    }
